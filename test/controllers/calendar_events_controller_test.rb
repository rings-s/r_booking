...
class CalendarEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar_event" do
    assert_difference("CalendarEvent.count") do
      post calendar_events_url, params: { calendar_event: { booking_id: @calendar_event.booking_id, business_id: @calendar_event.business_id, end_time: @calendar_event.end_time, start_time: @calendar_event.start_time, title: @calendar_event.title } }
    end
  ...
  test "should update calendar_event" do
    patch calendar_event_url(@calendar_event), params: { calendar_event: { booking_id: @calendar_event.booking_id, business_id: @calendar_event.business_id, end_time: @calendar_event.end_time, start_time: @calendar_event.start_time, title: @calendar_event.title } }
